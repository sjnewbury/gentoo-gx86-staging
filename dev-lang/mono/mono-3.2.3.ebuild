...
inherit eutils linux-info mono-env flag-o-matic pax-utils autotools-multilib
...
COMMONDEPEND="
	!dev-util/monodoc
	!minimal? ( >=dev-dotnet/libgdiplus-2.10[${MULTILIB_USEDEP}] )
	ia64? (	sys-libs/libunwind[${MULTILIB_USEDEP}] )
...
src_compile() {
	nonfatal autotools-multilib_src_compile || {
