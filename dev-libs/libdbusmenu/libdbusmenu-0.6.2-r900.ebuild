...
PDEPEND="gtk? ( gtk3? ( =dev-libs/libdbusmenu-gtk3-${PV}[${MULTILIB_USEDEP}]
                        =dev-libs/libdbusmenu-gtk2-${PV}[${MULTILIB_USEDEP}] )
				!gtk3? ( =dev-libs/libdbusmenu-gtk2-${PV}[${MULTILIB_USEDEP}] )
			  )
	"
