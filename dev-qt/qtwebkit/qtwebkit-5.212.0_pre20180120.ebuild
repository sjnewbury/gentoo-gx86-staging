...
inherit check-reqs cmake-utils flag-o-matic python-any-r1 qmake-utils ruby-single toolchain-funcs multilib-minimal
...
RDEPEND="
	...
	>=dev-qt/qtcore-${QT_MIN_VER}[${MULTILIB_USEDEP}]
