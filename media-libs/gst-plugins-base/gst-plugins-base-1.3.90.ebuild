...
# $Header: /var/cvsroot/gentoo-x86/media-libs/gst-plugins-base/gst-plugins-base-1.2.0.ebuild,v 1.1 2013/09/29 17:49:14 eva Exp $
...
multilib_src_configure() {
	ECONF_SOURCE="${S}" gst-plugins10_src_configure \
		$(use_enable alsa) \
