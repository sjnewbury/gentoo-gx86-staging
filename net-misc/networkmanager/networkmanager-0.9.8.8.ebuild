...
inherit bash-completion-r1 gnome.org linux-info systemd user readme.gentoo toolchain-funcs vala virtualx udev eutils multilib-minimal
...
COMMON_DEPEND="
	...
	>=dev-libs/dbus-glib-0.94[${MULTILIB_USEDEP}]
	>=dev-libs/glib-2.30[${MULTILIB_USEDEP}]
	...
	introspection? ( >=dev-libs/gobject-introspection-0.10.3[${MULTILIB_USEDEP}] )
